...
export default function MovieDetailPage() {
  ...
  if (!movie) {
    return (
      <main className="min-h-screen flex items-center justify-center" style={{ backgroundColor: "var(--bg)", color: "var(--text)" }}>
  ...
  <div className="max-w-5xl mx-auto card flex flex-col md:flex-row gap-6 shadow-md">
    {/* Poster */}
    <img
