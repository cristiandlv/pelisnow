...
{menuOpen && (
  <div className="md:hidden bg-white dark:bg-neutral-900 px-6 py-4 border-t border-neutral-200 dark:border-neutral-700 shadow-lg">
    <div className="flex flex-col gap-4">
      <Link
        href="/"
        className="text-gray-900 dark:text-gray-100 hover:text-purple-500 dark:hover:text-purple-300 transition"
      ...
      <div className="relative">
        <input
          ...
          onKeyDown={handleKeyDown}
          placeholder="Buscar..."
          className="w-full px-3 py-1.5 rounded-lg bg-neutral-100 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 text-sm text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-purple-400 dark:focus:ring-purple-500"
        />
        <button
          onClick={handleSearch}
          className="absolute right-2 top-1/2 -translate-y-1/2 text-gray-500 hover:text-purple-500 dark:text-gray-300 dark:hover:text-purple-400"
